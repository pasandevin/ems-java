...
public abstract class UIConstants {
    public static final String ASK_CHOICE = "Enter What you want to do";
    public static final String CHOICE_1 = "1. Add Employee";
    public static final String CHOICE_2 = "2. Get Employee by ID";
    public static final String CHOICE_3 = "3. Update Employee";
    ...
    public static final String PRINT_AGE = "Employee Age: ";
    public static final String PRINT_DEPARTMENT = "Employee Department: ";

    public static final String ASK_ID = "Enter Employee ID";
